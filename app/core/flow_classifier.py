...
async def flow_check(msg: str):    
    ...
    system_instruction = (
        ...
        "if the user message contains signing legal consent before ivf or anything about legal consent then classify it as legal_consent"
        "Return ONLY one word exactly from this list: "
        "book_appointment, ivf_success_calculator,Lifestyle_and_Preparations,cost_and_package,loan_and_emi,emergency_contact,success_rate,legal_consent,out_of_context,None. "
