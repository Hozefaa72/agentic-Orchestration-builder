...
async def flow_check(msg: str):
    ...
    "RULE 9: If the user asks any question which is irrelevant or  unrelated to IVF or Indira IVF or fertility or like who is rahul? etc → out_of_context.\n"
    ...
    "emergency_contact, success_rate, legal_consent,ivf_steps,emotional_support,out_of_context, None\n"
