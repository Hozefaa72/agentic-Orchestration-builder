...
async def initialize_chroma():
    ...
    faq_data = load_json("./src/backend/app/datasets/faq.json")
    clinic_data = load_json("./src/backend/app/datasets/ivf_clinic.json")
    need_data = load_json("./src/backend/app/datasets/need.json")
